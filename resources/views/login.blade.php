...
<!-- Register left side content wrapper -->
@section('leftAside')
    ...
    <div class="header d-flex justify-content-end align-items-center">
        ...
        @section('formContents')
            ...
            <form action="" method="head"> 
                ...
                </div><div class="createAcctBtn mt-4"><input type="submit" name="addNewUser" class="btn rounded-1" value="Create your account"></div>
