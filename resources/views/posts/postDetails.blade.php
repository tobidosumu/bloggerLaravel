...
@section('content')
    ...
    <section class="blogContents d-flex justify-content-between">
        ...
        <section class="mainContentContainer border-end"> 
            ...
            <nav class="my-3">
                <ul class="d-flex">
                    <li><a href="{{ url('/dashboard') }}">Posts</a></li>
            ...
            <div class="innerContainer"> 
                ...
                <!-- Post image -->
                <div class="postImage">
                    <img class="img-fluid w-100" src="{{ ('frontend_assets/assets/images/parisOne.jfif') }}"> <!-- displays post photo -->   
            ...
            <div class="productCard mt-3 border">
                <a href="#" class="d-flex flex-column align-items-center p-2"> <!-- product image link -->
                    <div class="productImage">
                        <img class="img-fluid" src="{{ ('frontend_assets/assets/images/addidas.webp') }}" alt="">
                    </div> 
