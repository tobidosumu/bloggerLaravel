...
@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets/styles/css/show.css') }}">
...
@section('content')
    ...
    <section class="blogContents d-flex justify-content-between">
        ...
        <aside class="rightSideContentContainer d-flex flex-column align-items-center pt-4 ps-2"> 

            <!-- Shop link -->
            <a href="#" class="captionCard d-flex align-items-center justify-content-between pe-3 border">
            ...
            <div class="productCard mt-3 border">
                <a href="#" class="d-flex flex-column align-items-center p-2"> 
                    ...
                    <div class="productContent">
                        ...
                        <div class="addToCart">
                            <button class="rounded-1" type="submit">
        ...
        <div id="blackModalBackground" onclick="closeEditModal()" class="blackModalBackground"> 
